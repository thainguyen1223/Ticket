import classes from './SettingPeople.module.css'
...
function Settingpeople({dataTable,fetchData }:any){
    useEffect(() => {
        fetchData();
      }, []);
...
const mapStateToProps = (state:any) =>{
  ...
  export default connect(mapStateToProps,mapDispatchToProps)(Settingpeople);